...
//Adler-32 hash function string hash function

int adler_32_hash_function(string key, int hash_table_size){
	int ADLERMOD = 65521;
    int a = 1, b = 0; // Given by the instructor
...
{
	int position = adler_32_hash_function(input_value, hash_table_size); //using mid square  base2 hash function
	int check = 0;
...
int delete_item(item hash_table[], string delete_value, int hash_table_size)
{
	...
	int position = adler_32_hash_function(delete_value, hash_table_size); // Using mid square base2 hash function
